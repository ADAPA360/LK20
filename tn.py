# "C:\Users\ali_z\ANU AI\LK20\tn.py"
# Project Chimera / Akkurat - Unified Tensor Network Library v3.1
...
def tensor_train_svd(
    ...
    *,
    ...
    # Critical v3.1 fix: keep working precision before SVD. Do not cast to dt first.
...
if __name__ == "__main__":
    print("--- TensorTrain unit tests (v3.1) ---")
